...
**Authentication** _(sẽ dùng từ Phase 3)_
...
- [x] Prisma migration _(chạy trên máy dev — xem lưu ý ở báo cáo Phase 2)_
...
| Phase | Nội dung                                                                       |
| ----- | ------------------------------------------------------------------------------ |
| 1     | Phân tích requirement, đề xuất architecture & database schema _(đã duyệt)_     |
| 2     | Project structure, setup frontend/backend, Prisma migration, seed _(hiện tại)_ |
